...
show create table ehrms2.eip_edEmp_profile;
...
show create table ehrms2.ac_user;
...
select * from information_schema.columns where TABLE_NAME='sys_log_pwd_change';

select * from ehrms2.sys_code;
select * from information_schema.columns where TABLE_NAME = 'sys_code';
